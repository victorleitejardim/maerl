...
# pdf("outputs/fetch_map.pdf", width= 16, height=11.25)
# map_fetch
# dev.off()
...
# pdf("outputs/fetch_map_brittany.pdf", width= 16, height=11.25)
# map_fetch
# dev.off()
```
...
# pdf("outputs/richesse_replicats.pdf")
...
# pdf("outputs/richesse_replicats_mean.pdf")
...
# pdf("outputs/richesse_replicats_phylum.pdf")
...
pdf("outputs/rarefaction.SM.pdf")
for(i in names(res)) {
...
## save as PDF
# pdf("outputs/pca_complex.pdf", width = 20, height = 8.75) 
...
# pdf("outputs//pca_complexT.pdf", width = 12, height = 5.25)
...
# pdf("outputs/Richness.pdf", width= 12, height=6)
...
export_summs(modfixalpha2,Smodsel, Smodsel_ran1, error_pos = "right", to.file = "docx", file.name = "outputs/models.docx")
...
# pdf("outputs/Density.pdf", width= 16, height=11.25)
...
# export_summs(modfixalpha2, Smodsel, to.file = "docx", file.name = "outputs/models.docx" )
...
pdf("outputs/pca_fauna.pdf", height = 5.25, width = 12)
...
maerl_dens_rda <- maerl_dens %>%
  rename(site = Site)
# pdf("outputs/Partial_RDA_1_2.pdf", width = 12.39, height = 10.01)
...
# pdf("outputs/Partial_RDA_1_3.pdf", width = 12.39, height = 10.01)
...
#library(UpSetVP)
# pdf("outputs/upsetvp_sites.pdf",width = 12, height = 6)
...
dev.off()
pdf("outputs/upsetvp.pdf", width = 12, height = 6)
...
# pdf("outputs/BetaPartition.pdf", width = 12, height=6)
...
ggplot(data =  bdcomplex, aes(y = BDtotal, fill = Site))+
  ...
  scale_fill_manual(values = pal)
##---- PC1 ----
# pdf("outputs/BDTOT_PC1_full.pdf",  width= 16, height=11.25)
...
##---- PC2 ----
# pdf("outputs/BDTot_PC2_full.pdf",  width= 16, height=11.25)
...
# pdf("outputs/BDTot_PC2_sT.pdf",  width= 16, height=11.25)
...
export_summs(bdtotfix3, to.file = "docx", file.name = "outputs/models_bdtot.docx")  
...
pdf("outputs/bdtot2.pdf", width= 12, height=6)
